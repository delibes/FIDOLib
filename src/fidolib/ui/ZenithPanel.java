...
public class ZenithPanel extends javax.swing.JPanel {
    ...
    private double origonX;
    private double origonY;
    ...
    private void drawFlightDirection(Graphics g) {
        ...
        g.setFont(boldFont);
        String s = "(" + (int) xDegree + degreeChar + "," + (int) zDegree + degreeChar + ")";
        int sLength = g.getFontMetrics().stringWidth(s);
        int sHeight = g.getFontMetrics().getHeight();
        ...
        sLength = g.getFontMetrics().stringWidth(pitchStr);
        sHeight = g.getFontMetrics().getHeight();
        g.drawString(pitchStr, ((int) origonX - sLength / 2), sHeight + 4);



        String yawStr = "Yaw";
        sLength = g.getFontMetrics().stringWidth(yawStr);
